...
class TaskHandle:
    ...
    def auto_search_targets(self) -> bool:
        return self._task.auto_search_targets
    ...
    def target_resource_flag(self) -> bool:
        return self._task.target_resource_flag
    ...
    def move_sprite_id(self) -> int:
        return self._task.move_sprite_id
    ...
    def wwise_resource_gather_sound_id(self) -> int:
        return self._task.wwise_resource_gather_sound_id
    ...
    def wwise_resource_deposit_sound_id(self) -> int:
        return self._task.wwise_resource_deposit_sound_id
    ...
    def resource_which_enables_task(self) -> int:
        return self._task.resource_which_enables_task
