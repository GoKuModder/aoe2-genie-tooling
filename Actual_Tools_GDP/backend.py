...
try:
    ...
    from sections.tech.tech import Tech as _G_Tech, ResourceCost as _G_ResourceCost
    ...
    try:
        ...
        from genieutils.tech import Tech, ResourceCost
...
# EXPORTS
# =============================================================================
__all__ = ["DatFile", "Unit", "Civ", "Tech", "Graphic", "ResourceCost", "BACKEND_NAME"]
